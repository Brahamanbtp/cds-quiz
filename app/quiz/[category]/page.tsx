    ...
    <div className="min-h-screen bg-black text-gray-300 py-12 px-4 sm:px-6 lg:px-8 font-mono">
      <div className="max-w-3xl mx-auto">
        ...
        {!loading && !error && category && (
          <div>
            <h2 className="text-xl font-semibold mb-6 text-white">Select a Year to Practice</h2>
              ...
              {topics.length > 1 && (
                ...
                >
                  <span className="flex items-center">
                    ...
                    <span className="text-lg">All Years</span>
                  </span>
                  <ArrowRight size={20} />
                </Link>
              )}
