...
const mathsData: Record<string, Question[]> = {
    ...
    "2023-II": [
        ...
        },
        {
            ...
            "direction": "<b>Directions:</b> Consider the following for the next two (02) items that follow:<br/>"
        },
        {
        ...
        {
            "question": "AB is a straight road leading to the foot P of a tower of height h. Q is at distance x from P and R is at a distance y from Q (R is farther from P than Q; R, Q are on the same side). The angle of elevation of the top of the tower at Q is twice of that at R. (Use the formula tan 2&theta; = <sup>2 tan &theta;</sup>&frasl;<sub>(1 &minus; tan<sup>2</sup> &theta;)</sub>)<br/><br/>Which one of the following is correct ?",
            "options": [
                "x = y",
                "x &lt; y",
                "x &gt; y",
        ...
        {
            "question": "Two parallel chords AB and CD of a circle are of lengths 60 cm and 80 cm respectively. They are on the same side of the centre O and 10 cm apart.<br/><br/>What is the diameter of the circle ?",
            "options": [
                "120 cm",
                "110 cm",
                "100 cm",
        ...
        {
            "question": "Let p = x<sup>4</sup> &minus; y<sup>2</sup>z<sup>2</sup>, q = y<sup>4</sup> &minus; z<sup>2</sup>x<sup>2</sup>, r = z<sup>4</sup> &minus; x<sup>2</sup>y<sup>2</sup>.<br/><br/>What is px<sup>2</sup> + qy<sup>2</sup> + rz<sup>2</sup> equal to ?",
            "options": [
        ...
        {
            "question": "A right conical cap just covers two spheres placed one above the other on a table such that it touches both the spheres. Let r be the radius of the smaller sphere and R be the radius of the bigger sphere. Let 2&theta; be the vertical angle of the cone.<br/><br/>What is the height of the cone ?",
            "options": [
        ...
        {
            "question": "Let <sup>(x &minus; a)(x &minus; b)</sup>&frasl;<sub>(x &minus; ma)(x &minus; mb)</sub> = <sup>(x + a)(x + b)</sup>&frasl;<sub>(x + ma)(x + mb)</sub> ; m, a, b &gt; 0.<br/><br/>What is <sup>(x<sup>2</sup> + ab)</sup>&frasl;<sub>(x<sup>2</sup> + m<sup>2</sup>ab)</sub> equal to ?",
            "options": [
        ...
        {
            "question": "A grouped frequency distribution is given below :<br/><br/>Weekly wages in Rupees (&#x20B9;) | Numbers of workers<br/>2050 - 2550 | 5<br/>2550 - 3050 | 10<br/>3050 - 3550 | k<br/>3550 - 4050 | 8<br/>4050 - 4550 | 2<br/>4550 - 5050 | 10<br/><br/>If average weekly wages earned by a worker is &#x20B9; 3,520, then what is the value of k ?",
            "options": [
                "10",
                "12",
                "15",
        ...
        {
            "question": "A quadratic equation is given by<br/>(a + b + c) x<sup>2</sup> &minus; (2a + 2b) x + (a + b &minus; c) = 0;<br/>where a, b and c are real and distinct.<br/><br/>What are the roots of the equation ?",
            "options": [
        ...
        },
        {
            ...
            "answer": "18",
            "direction": "<b>Directions:</b> Consider the following for the next (05) items that follow:<br/>"
        },
        {
        ...
        {
            "question": "<i>Question :</i> Is m &gt; n if m, n are real numbers ?<br/><br/><i>Statement-I :</i><br/>m = (1 &minus; p) (p<sup>2</sup> + p + 1) and<br/>n = (p + 1) (p<sup>2</sup> &minus; p + 1)<br/><br/><i>Statement-II :</i><br/>m = pn",
            "options": [
                "The question can be answered by using one of the statements alone, but cannot be answered using the other statement alone.",
                "The question can be answered by using either statement alone.",
                "The question can be answered by using both the statements together, but cannot be answered using either statement alone.",
            ...
            "direction": "<b>Directions:</b> Consider the following for the next ten (10) items that follow :<br/><br/>"
        },
        {
    ...
    "2024-I": [
        ...
        {
            "question": "Each item contains a Question followed by two Statements. Answer each item using the following instructions:<br/><br/>Let a, b, c and d be positive integers.<br/><br/><i>Question :</i> Which one of a, b, c, d is closest to the product abcd ?<br/><br/><i>Statement-I :</i> a &gt; b &gt; c<br/><i>Statement-II :</i> c is not the smallest.",
            "options": [
            ...
            "direction": "<b>Directions:</b> Consider the following for the next ten (10) items that follow:<br/>"
        },
        {
        ...
        {
            "question": "In a pie-diagram (with radius 7 cm), the central angles of the sectors are in the ratio 2 : 3 : 7 : 5 : 1.<br/>(Take &pi; = 22/7)<br/><br/>If P is the area of the smallest sector and Q is the area of the largest sector, then what is P + Q equal to ?",
            "options": [
                "88/3 square cm",
                "77/3 square cm",
                "149/6 square cm",
        ...
        {
            "question": "Two trains A and B started from stations P and Q respectively towards each other. Train A started at 7 p.m. at a speed of 60 km/hr and train B started at 4 a.m. (next day) at a speed of 90 km/hr. The distance between the two stations P and Q is 800 km.<br/><br/>How far from station Q will the two trains meet ?",
            "options": [
                "104 km",
                "144 km",
                "156 km",
            ...
            "answer": "156 km",
            "direction": "<b>Directions:</b> Consider the following for the next three (03) items that follow:<br/>"
        },
        {
        ...
        {
            "question": "A triangle CEF is drawn inside a square ABCD. Given : CF = 8 cm, EF = 6 cm and CE = 10 cm. Angle &alpha; is &ang;FCB and angle &beta; is &ang;AEF.<br/><br/>What is the area of the square ?",
            "options": [
                "512/17 square cm",
                "625/13 square cm",
                "1024/17 square cm",
        ...
        {
            "question": "ABCD is a circle with centre O and taking OC as a diameter, a smaller circle is drawn. Let OB = 7 cm. (Use &pi; = 22/7)<br/><br/>What is the area of the shaded region (comprising the smaller circle on OC and the segments bounded by chords AB, AD and arcs AB, AD) ?",
            "options": [
        ...
        {
            "question": "Let two parallel line segments PQ = 5 cm and RS = 3 cm be perpendicular to a horizontal line AB. The point of intersection of PS and QR is M and MN is perpendicular to QS.<br/><br/>What is the length of MN ?",
            "options": [
                "3/8 cm",
                "5/8 cm",
                "9/8 cm",
        ...
        {
            "question": "Consider two identical rectangles ABCD and BEDF. Let AB = 1 cm and BC = 2 cm. They share the diagonal BD.<br/><br/>What is the area of the overlapping region ?",
            "options": [
                "8/5 square cm",
                "5/4 square cm",
                "4/5 square cm",
        ...
        {
            "question": "ABC is a right-angled triangle with &ang;ABC = 90&deg;. The centre of the incircle of the given triangle is at O, whose radius is 2 cm. Two more circles with centres at O<sub>1</sub> and O<sub>2</sub>, touch this circle and the two sides. Further, MA : MC = 2 : 3 (where M is the point of contact on AC).<br/><br/>What is AB + BC equal to ?",
            "options": [
                "10 cm",
                "12 cm",
                "13 cm",
        ...
        {
            "question": "Consider two identical semicircles and one circle inscribed in a rectangle of length 10 cm. The semicircles are on the left and right sides. (Take &pi; = 3&middot;14 and &radic;2 = 1&middot;4).<br/><br/>What is the area of triangle EOF (where O is the top center and E, F are intersection points) ?",
            "options": [
        ...
        {
            "question": "Consider a circle of area 9&pi; square unit and an equilateral triangle ABC as shown in the figure given below. The circle passes through A and is tangent to BC at its midpoint.<br/><br/>What is the length of the side of the triangle ABC ?",
            "options": [
                "2&radic;3 unit",
                "4&radic;3 unit",
                "6&radic;3 unit",
        ...
        {
            "question": "Two circles with centres at O<sub>1</sub> and O<sub>2</sub> touching each other are placed inside a rectangle of sides 9 cm and 8 cm. The larger circle O<sub>1</sub> touches three sides of the rectangle, and the smaller circle O<sub>2</sub> touches two sides and the larger circle.<br/><br/>What is the sum of the areas of the two circles ?",
            "options": [
                "17&pi; square unit",
